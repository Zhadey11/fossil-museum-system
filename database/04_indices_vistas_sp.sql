...
-- IMPORTANTE: modos 0 y 1 requieren Full-Text instalado (03_fulltext_fosiles.sql ejecutado).
    ...
    WHERE
        ...
        AND (
            ...
            OR (
                ...
                AND (
                    CONTAINS((f.nombre, f.nombre_comun, f.nombre_cientifico, f.descripcion_general, f.descripcion_detallada,
            ...
            OR (
                ...
                AND (
                    FREETEXT((f.nombre, f.nombre_comun, f.nombre_cientifico, f.descripcion_general, f.descripcion_detallada,
                               f.descripcion_estado_orig, f.contexto_geologico,
                               f.descripcion_ubicacion, f.notas_revision), @search_ft)
            ...
            OR (
                ...
                AND (
                    ...
                    OR (f.nombre_comun IS NOT NULL AND CHARINDEX(@nombre, f.nombre_comun) > 0)
                    OR (f.nombre_cientifico IS NOT NULL AND CHARINDEX(@nombre, f.nombre_cientifico) > 0)
...
-- Full-Text: catalogo e indices en 03_fulltext_fosiles.sql (despues de 02, antes de este archivo).
